...
struct HookEvent: Codable, Sendable {
    ...
    init(sessionId: String, cwd: String, event: String, status: String, pid: Int?, tty: String?, cmuxSurfaceId: String? = nil, tool: String?, toolInput: [String: AnyCodable]?, toolUseId: String?, notificationType: String?, message: String?) {
